...
unique_solutions = messages.groupby(['group', 'task'])['variant'].nunique()
varied_solutions = unique_solutions.groupby('group').mean().sort_values(ascending=False)
plt.figure(figsize=(12, 6))
varied_solutions.plot(kind='bar', title='Группы с разными способами решения задач')
